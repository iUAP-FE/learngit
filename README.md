...
作为新时代的好码农，使用git和github来进行学习和交流是必备技能之一。什么，你都没听过，我擦勒，还能不能愉快的玩耍了。掌握git和github的使用，可以带你装逼带你飞，比如说，可以抄大婶的代码啊，哈哈...(此处省略一万个暗笑)。还可以直接看流行技术的源码和demo啊，再也不用去各大群里弱弱的问：大神，react怎么学啊，大牛，教我nodejs吧...
